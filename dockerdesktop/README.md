# Docker Desktop - Platform for creating, managing, and deploying containers
...
Example :
 ...
 | HKLM | Docker Desktop | Docker Inc. | 4.60.0 | `Docker Desktop` | `"C:\Program Files\Docker\Docker\Docker Desktop Installer.exe" "uninstall"` |
