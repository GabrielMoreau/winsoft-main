...
REM SET "qexeadmin=__QEXEADMIN__"
SET "mainexe=%ProgramFiles%\DigiCamControl\zotero.exe"
...
ScriptRunner.exe -appvscript digiCamControlsetup_%softversion%.exe /S -appvscriptrunnerparameters -wait -timeout=300
IF "%RETURNCODE%"=="0" SET "RETURNCODE=%ERRORLEVEL%"
