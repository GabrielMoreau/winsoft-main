...
Example :
 ...
 | HKLM | LibreOffice 26.2 Help Pack (French) | The Document Foundation | 26.2.0.3 | `{69D36388-2AA9-4AD5-A5D0-F1F6A7DF72C8}` | `MsiExec.exe /I{69D36388-2AA9-4AD5-A5D0-F1F6A7DF72C8}` |
 | HKLM | LibreOffice 26.2.0.3                | The Document Foundation | 26.2.0.3 | `{5B9B7FC3-E7A6-4B71-922B-BDAB5FD55147}` | `MsiExec.exe /I{5B9B7FC3-E7A6-4B71-922B-BDAB5FD55147}` |
