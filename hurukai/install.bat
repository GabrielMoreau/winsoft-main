...
SET "qexeadmin=true"
SET "mainexe=%ProgramData%\HarfangLab\ui\hurukai-ui.exe"
...
ScriptRunner.exe -appvscript MsiExec.exe /i "hurukai-%softversion%-x86_64.msi" HOST=__HURUKAI_SERVER__ PORT=443 PROTO=https SRV_SIG_PUB=__HURUKAI_SIG__ ENROLLMENT_TOKEN=__HURUKAI_TOKEN__ /qn /L*v "%logdir%\%softname%-MSI.log" -appvscriptrunnerparameters -wait -timeout=300
IF "%RETURNCODE%"=="0" SET "RETURNCODE=%ERRORLEVEL%"
