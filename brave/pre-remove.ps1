...
# "C:\Program Files\BraveSoftware\Brave-Browser\Application\144.1.86.142\Installer\setup.exe" --uninstall --system-level --force-uninstall
...
ForEach ($Key in Get-ChildItem -Recurse $UninstallKeys) {
	...
	If ($($App.UninstallString) -match 'setup.exe') {
