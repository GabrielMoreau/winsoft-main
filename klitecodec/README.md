# K-Lite Codec Pack - Vector graphics editor
...
Example :
 ...
 | HKLM | K-Lite Codec Pack 19.3.0 Standard | KLCP | 19.3.0 | `KLiteCodecPack_is1` | `"C:\Program Files (x86)\K-Lite Codec Pack\unins000.exe"` |
