...
SET "mainexe=%ProgramFiles%\digiKam\digikam.exe"
SET "mainexe=%mainexe%;%ProgramFiles%\digiKam\exiftool.exe"
SET "mainexe=%mainexe%;%ProgramFiles%\digiKam\showphoto.exe"
